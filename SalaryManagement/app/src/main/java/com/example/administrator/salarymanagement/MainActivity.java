...
import com.example.administrator.fenxi.FenxiActivity;
import com.example.administrator.tongzhi.TongzhiActivity;
...
public class MainActivity extends Activity implements ViewPager.OnPageChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //开始做点击
        //指向这个layout
        View tv = findViewById(R.id.file);
        //onclick
        ...
        //开始做点击2
        //指向这个layout
        View tv2 = findViewById(R.id.question);
        //onclick
        tv2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View arg0) {
                Intent i = new Intent(MainActivity.this, QuesActivity.class);
                ////启动
                startActivity(i);
            }
        ...
        //开始做点击3
        //指向这个layout
        View tv3 = findViewById(R.id.chaxun);
        //onclick
        tv3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View arg0) {
                Intent i = new Intent(MainActivity.this, ChaxunActivity.class);
                ////启动
                startActivity(i);
            }
        ...
        //开始做点击4
        //指向这个layout
        View tv4 = findViewById(R.id.news);
        //onclick
        ...
        //开始做点击4
        //指向这个layout
        View tv5 = findViewById(R.id.tongzhi);
        //onclick
        tv5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View arg0) {
                Intent i = new Intent(MainActivity.this, TongzhiActivity.class);
                ////启动
                startActivity(i);
            }
        ...
        //指向这个layout
        View tv6 = findViewById(R.id.fenxi);
        //onclick
        tv6.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View arg0) {
                Intent i = new Intent(MainActivity.this, FenxiActivity.class);
                ////启动
                startActivity(i);
            }
